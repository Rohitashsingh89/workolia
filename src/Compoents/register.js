                            ...
                            <div className="form-field">
                                ...
                                <div className="form signup-form">
                                        ...
                                        <div className="password-strength mg-t10" data-bind="css: meterclassName">
                                            ...
                                            <p className="password-strength__hint">
                                                ...
                                                <img width="17px" className="icon"
                                                    src="https://d1lvv0q42gy9jf.cloudfront.net/R20230309_1/assets/img/common/indicator/indicator_sending.gif" alt="Gif"
                                    ...
                                    <div className="form__field align-center -mg-b-lg">
                                        <p className="form__text">By signing up, I agree to Workolia Inc.'s <a href="https://workolia.com/terms/" target="_blank" rel="noreferrer">Terms of
                                            Service</a> and <a href="https://workolia.com/privacy/" target="_blank" rel="noreferrer">Privacy Policy</a>.</p>
                                    </div>
